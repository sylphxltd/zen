/**
 * @rapid/compiler - Optional JSX transformer for Rapid
 *
 ...
 * Platform-agnostic - works with @rapid/web, @rapid/native, @rapid/tui
 */
...
export { transformRapidJSX } from './core/transform.js';
