 ...
 *
 * Architecture mirrors @rapid/web's simple render() API:
...
import { createRoot, signal } from '@rapid/signal';
...
// ============================================================================
// Simple render() API - mirrors @rapid/web
// ============================================================================

/**
 * Render a TUI application.
 *
 * This is the main entry point for TUI apps, mirroring @rapid/web's API:
