...
// ============================================================================
// Re-export @rapid/runtime for convenience
// ============================================================================
export {
  // Signals
  signal,
...
export type { Signal, Computed, Owner, Context, MaybeReactive, Reactive } from '@rapid/runtime';
...
export { setPlatformOps } from '@rapid/runtime';
...
// ============================================================================
// Router primitives (re-export from @rapid/router-core)
// ============================================================================
export {
  $router,
  defineRoutes,
