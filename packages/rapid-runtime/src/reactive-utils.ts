...
import type { AnySignal } from '@rapid/signal';
import { createOwner, getOwner, setOwner } from '@rapid/signal';
...
export function executeComponent<T>(
  fn: () => T,
  attachToOwner?: (node: T, owner: import('@rapid/signal').Owner) => void,
): T {
